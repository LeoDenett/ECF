                    ...
                    <Col xs={12}>
                        <Form style={{marginBottom: '20px'}}>
                            <FormControl
                                ...
                                className="mr-2"
                                aria-label="Search"
                                placeholder="Faites votre recherche parmi nos 42 500 livres disponibles"
                            />
                            <BsSearch type="submit" size={25} style={{position: 'relative', bottom: '34px', left: '15px', color: '#7ACBCD'}}/>
                        </Form>
                    </Col>
                    <Col xs={12} sm={6} className="Mp-0">
                            ...
                            <Col xs={6} sm={6} md={6} lg={6} className="Mp-0">
                                <Card className="Img-overlay">
                                    ...
                                    <Card.ImgOverlay className="Mp-0 Center">
                                        <Card.Title className="Catalogue-Titles">Enfants</Card.Title>
                                    </Card.ImgOverlay>
                                </Card>
                            </Col>
                        ...
                        <Row style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}} className="Mp-0">
                            <Col xs={6} sm={6} lg={6} className="Mp-0">
                                <Card className="Img-overlay">
                                    ...
                                    <Card.ImgOverlay className="Mp-0 Center">
                                        <Card.Title className="Catalogue-Titles">Adults</Card.Title>
                                    </Card.ImgOverlay>
                                </Card>
                            </Col>
                            <Col className="Catalogue-In" xs={6} sm={6}><h4 className="Mp-0 Bolder">ALBUMS POUR ADULTS</h4></Col>
                        </Row>
                    </Col>
                </Row>
                <Row>
